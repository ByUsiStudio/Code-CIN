---
description: "Code CIN 指令集编码表 (共 112 条): Base / ARM64 / FP / Vector / RISC-V / SYS 分组的助记符与编码, 由 codecin/isa.py 自动生成。"
---

# 指令集编码表

> 本文档由 `python script/gen_isa_docs.py` 从 `codecin/isa.py` 自动生成, 请勿手工编辑。
...
---
*Generated by `script/gen_isa_docs.py` from `codecin/isa.py`.*
